  ...
  return (
    <div className='flex font-Poppins'>
      ...
      <div
        ...
        className='flex-1 h-screen flex flex-col items-center justify-center bg-center bg-cover'
      >
        <div className='bg-white absolute w-full h-full opacity-70'></div>
        <h1 className='font-semibold text-6xl uppercase z-50'>Sign Up</h1>
        <SignUpForm />
      </div>
      {/* right */}
      <div
      ...
      >
        <div className='bg-indigo-900/75 h-full w-full absolute flex justify-center items-center px-12'>
          <div className='text-center'>
            ...
            <p className='text-gray-300 text-xl font-light w-5/6 mt-3 mx-auto leading-9 animate-pulse'>
